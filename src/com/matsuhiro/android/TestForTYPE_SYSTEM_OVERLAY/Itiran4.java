...
public class Itiran4 extends Activity implements 
OnClickListener,OnLongClickListener,OnItemClickListener{
	...
	public void mes(ApplicationInfo ai){
		...
		Intent intent =new Intent(Itiran4.this, MainActivity.class);
		intent.putExtra("pkname4",ai.packageName.toString());
