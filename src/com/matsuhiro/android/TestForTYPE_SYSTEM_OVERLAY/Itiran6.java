...
public class Itiran6 extends Activity implements 
OnClickListener,OnLongClickListener,OnItemClickListener{
	...
	public void mes(ApplicationInfo ai){
		...
		Intent intent =new Intent(Itiran6.this, MainActivity.class);
		intent.putExtra("pkname6",ai.packageName.toString());
