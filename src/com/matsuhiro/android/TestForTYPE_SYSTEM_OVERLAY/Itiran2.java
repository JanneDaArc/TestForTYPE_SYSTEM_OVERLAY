...
public class Itiran2 extends Activity implements 
OnClickListener,OnLongClickListener,OnItemClickListener{
	...
	public void mes(ApplicationInfo ai){
		...
		Intent intent =new Intent(Itiran2.this, MainActivity.class);
		intent.putExtra("pkname2",ai.packageName.toString());
