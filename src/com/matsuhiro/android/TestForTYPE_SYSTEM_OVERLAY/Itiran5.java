...
public class Itiran5 extends Activity implements 
OnClickListener,OnLongClickListener,OnItemClickListener{
	...
	public void mes(ApplicationInfo ai){
		...
		Intent intent =new Intent(Itiran5.this, MainActivity.class);
		intent.putExtra("pkname5",ai.packageName.toString());
